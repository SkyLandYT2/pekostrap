...
namespace PekoraStrap
{
    public class Pekostrap
    {
        ...
        private string GetClientExePath(string version)
        {
            try
            {
                string basePath = Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.LocalApplicationData), "Pekora", "Versions");
                ...
                string[] possibleExeNames = { "ProjectXPlayerBeta.exe", "PekoraPlayerLauncher.exe", "ProjectXPlayer2017.exe" };
        ...
        private (string year, string placeId, string token, int? pid, DateTime? startTime, string processName) GetPekoraYearPlaceAndToken()
        {
            try
            {
                string[] processNames = { "ProjectXPlayerBeta.exe", "PekoraPlayerLauncher.exe", "ProjectXPlayer2017.exe" };
