...
namespace PekoStrap
{
    public partial class MainForm : Form
    {
        ...
        private void LaunchButton_Click(object sender, EventArgs e)
        {
            try
            {
                string gameFolder = "Pekora"; // Default value
                ...
                if (File.Exists(_settingsPath))
                {
                    try
                    {
                        ...
                        if (root.TryGetProperty("GameFolder", out JsonElement gameFolderElement) && gameFolderElement.ValueKind == JsonValueKind.String)
                        {
                            ...
                            {
                                gameFolder = "Pekora";
                                Log($"GameFolder is empty in {_settingsPath}, defaulting to Pekora");
                            }
                            else
                            {
                        ...
                        {
                            Log($"GameFolder not found in {_settingsPath}, defaulting to Pekora");
                        }
                    ...
                    {
                        Log($"Error parsing {_settingsPath}: {ex.Message}, defaulting to GameFolder=Pekora");
                    }
                }
                else
                {
                    Log($"Settings file not found: {_settingsPath}, defaulting to GameFolder=Pekora");
                }
